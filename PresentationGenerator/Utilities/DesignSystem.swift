...
enum DesignSystem {
    ...
    enum Shadows {
        ...
        static let lg = Shadow(color: .black.opacity(0.1), radius: 20, x: 0, y: 10)
        static let xl = Shadow(color: .black.opacity(0.15), radius: 30, x: 0, y: 15)
...
extension View {
    ...
    /// Modern playground card styling with glassmorphism
    func playgroundCard() -> some View {
        self
    ...
    /// Gradient button style for primary CTAs
